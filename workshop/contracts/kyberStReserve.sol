...
contract KyberStReserve is KyberReserveInterface, Withdrawable, Utils {
    ...
    function KyberStReserve(address _kyberNetwork, ConversionRatesInterface _ratesContract, address _admin) public {
