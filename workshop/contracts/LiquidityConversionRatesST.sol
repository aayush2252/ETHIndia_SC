...
contract LiquidityConversionRatesST is ConversionRatesInterface, LiquidityFormula, Withdrawable, Utils {
    ERC20 public token;
    ...
    function LiquidityConversionRatesST(address _admin, ERC20 _token) public {
