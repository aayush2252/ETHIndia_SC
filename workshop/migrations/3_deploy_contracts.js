...
module.exports = async (deployer, network, accounts) => {
  ...
  await deployer.deploy(LiquidityConversionRatesST, admin, ST.address);
  ...
  await deployer.deploy(STReserve, Network.address, LiquidityConversionRatesST.address, admin);
